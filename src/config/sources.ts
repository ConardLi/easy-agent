 ...
 *
 *   user    ~/.easy-agent/settings.json            cross-project, shareable
 *   project <cwd>/.easy-agent/settings.json        per-repo, committed
 *   local   <cwd>/.easy-agent/settings.local.json  per-repo, gitignored
